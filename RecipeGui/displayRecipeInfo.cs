    ...
    {//author: Mosa Tshikane(ST10036192)
        ...
        static void displayRecipeAlphabetically()
        {
            ...
            *
            ...
            {
               MessageBox.Show($"{i + 1}. {sortedRecipes[i].getName()}","Available Recipes");
            }
                ...
                case "3":
                    {
                        try
                        {
                            MessageBox.Show("Enter your scale factor number : ");//this will  be prompting the user to input the scale factor to be used
                        ...
                        {
                           MessageBox.Show("An exception has occured please check your scale factor number." + ex.Message);
                        }
